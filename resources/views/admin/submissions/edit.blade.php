<x-layouts.admin.app>
    <x-slot name="title">Edit Permohonan #SH2024-{{ str_pad($id, 3, '0', STR_PAD_LEFT) }}</x-slot>

    <!-- Page Header -->
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1" style="font-size: 1.75rem; font-weight: 600;">Edit Permohonan #SH2024-{{ str_pad($id, 3, '0', STR_PAD_LEFT) }}</h2>
            <p class="text-secondary-light mb-0">Perbarui informasi permohonan sertifikasi halal</p>
        </div>
        <div>
