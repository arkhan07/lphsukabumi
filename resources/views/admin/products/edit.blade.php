<x-layouts.admin.app>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1" style="font-size: 1.75rem; font-weight: 600;">Edit Produk</h2>
            <p class="text-secondary-light mb-0">Perbarui informasi produk</p>
        </div>
    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
                    ...
                    <div class="row g-3">
                            ...
                            <select class="form-select @error('submission_id') is-invalid @enderror" name="submission_id" required>
                                ...
                                @foreach($submissions ?? [] as $submission)
                                    <option value="{{ $submission->id }}"
                                            {{ (old('submission_id', $product->submission_id) == $submission->id) ? 'selected' : '' }}>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('brand_name') is-invalid @enderror"
                                   name="brand_name" value="{{ old('brand_name', $product->brand_name) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('variant') is-invalid @enderror"
                                   name="variant" value="{{ old('variant', $product->variant) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('packaging_type') is-invalid @enderror"
                                   name="packaging_type" value="{{ old('packaging_type', $product->packaging_type) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('product_description') is-invalid @enderror"
                                      ...
                                      placeholder="Deskripsi detail tentang produk">{{ old('product_description', $product->product_description) }}</textarea>
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control @error('net_weight') is-invalid @enderror"
                                       name="net_weight" value="{{ old('net_weight', $product->net_weight) }}"
                                       placeholder="0.00">
                                <select class="form-select @error('weight_unit') is-invalid @enderror" name="weight_unit" style="max-width: 100px;">
                                    ...
                                    <option value="ml" {{ old('weight_unit', $product->weight_unit) == 'ml' ? 'selected' : '' }}>ml</option>
                                    <option value="liter" {{ old('weight_unit', $product->weight_unit) == 'liter' ? 'selected' : '' }}>liter</option>
                                </select>
                            </div>
                            @error('net_weight')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('hs_code') is-invalid @enderror"
                                   name="hs_code" value="{{ old('hs_code', $product->hs_code) }}"
                                   placeholder="Kode HS">
                            @error('hs_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number" class="form-control @error('monthly_production_volume') is-invalid @enderror"
                                   name="monthly_production_volume" value="{{ old('monthly_production_volume', $product->monthly_production_volume) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" class="form-control @error('shelf_life_duration') is-invalid @enderror"
                                       name="shelf_life_duration" value="{{ old('shelf_life_duration', $product->shelf_life_duration) }}"
                                       placeholder="0">
                                <select class="form-select @error('shelf_life_unit') is-invalid @enderror" name="shelf_life_unit" style="max-width: 120px;">
                                    <option value="">Pilih</option>
                                    <option value="days" {{ old('shelf_life_unit', $product->shelf_life_unit) == 'days' ? 'selected' : '' }}>Hari</option>
                                    <option value="weeks" {{ old('shelf_life_unit', $product->shelf_life_unit) == 'weeks' ? 'selected' : '' }}>Minggu</option>
                                    <option value="months" {{ old('shelf_life_unit', $product->shelf_life_unit) == 'months' ? 'selected' : '' }}>Bulan</option>
                                    <option value="years" {{ old('shelf_life_unit', $product->shelf_life_unit) == 'years' ? 'selected' : '' }}>Tahun</option>
                                </select>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('ingredients') is-invalid @enderror"
                                      ...
                                      placeholder="Daftar komposisi bahan produk">{{ old('ingredients', $product->ingredients) }}</textarea>
                            @error('ingredients')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row g-3">
                            ...
                            <div class="d-flex gap-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="halal_status" id="halal"
                                           value="halal" {{ old('halal_status', $product->halal_status) == 'halal' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="halal_status" id="not_halal"
                                           value="not_halal" {{ old('halal_status', $product->halal_status) == 'not_halal' ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="halal_status" id="doubtful"
                                           value="doubtful" {{ old('halal_status', $product->halal_status) == 'doubtful' ? 'checked' : '' }}>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('halal_notes') is-invalid @enderror"
                                      ...
                                      placeholder="Catatan terkait status halal produk">{{ old('halal_notes', $product->halal_notes) }}</textarea>
                            @error('halal_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control @error('certificate_number') is-invalid @enderror"
                                   name="certificate_number" value="{{ old('certificate_number', $product->certificate_number ?? '') }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="date" class="form-control @error('certificate_issue_date') is-invalid @enderror"
                                   name="certificate_issue_date" value="{{ old('certificate_issue_date', $product->certificate_issue_date ?? '') }}">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="date" class="form-control @error('certificate_expiry_date') is-invalid @enderror"
                                   name="certificate_expiry_date" value="{{ old('certificate_expiry_date', $product->certificate_expiry_date ?? '') }}">
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="card-custom mb-3">
                    ...
                    <div class="mb-3">
                        <div class="border rounded p-3 text-center" style="min-height: 200px; background: var(--neutral-50);">
                            @if($product->image)
                                <img id="imagePreview" src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->product_name }}"
                    ...
                    @enderror
                    @if($product->image)
                        <small class="text-secondary-light d-block mt-2">Gambar saat ini akan diganti jika Anda upload gambar baru</small>
                    @endif
                </div>
                ...
                <!-- Info -->
                <div class="card-custom mb-3" style="background: var(--info-50); border: 1px solid var(--info-200);">
                    <div class="d-flex align-items-start gap-2">
                        <i class="ri-information-line text-info" style="font-size: 1.25rem;"></i>
                        <div>
                            <small class="text-info d-block mb-1" style="font-weight: 500;">Informasi</small>
