        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <p class="text-gray-600">Anda login sebagai <span class="font-semibold text-indigo-600">Admin LPH</span></p>
                    <p class="text-sm text-gray-500 mt-2">Kelola semua aspek operasional LPH Doa Bangsa Sukabumi dari dashboard ini.</p>
                </div>
            </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Pending Invoice</p>
                                <p class="text-2xl font-semibold text-gray-900">0</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div>
                                <p class="font-semibold">Kelola Pengajuan</p>
                                <p class="text-sm text-gray-500">Screening pengajuan</p>
                            </div>
                        </a>
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div>
                                <p class="font-semibold">Kelola Auditor</p>
                                <p class="text-sm text-gray-500">Manajemen auditor</p>
                            </div>
                        </a>
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                            ...
                            <div>
                                <p class="font-semibold">Kelola Invoice</p>
                                <p class="text-sm text-gray-500">Tagihan & pembayaran</p>
                            </div>
                        </a>
                        <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
