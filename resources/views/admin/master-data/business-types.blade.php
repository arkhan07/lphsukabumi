        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Jenis Usaha</h2>
                </div>
        ...
        <div class="container-xl">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Total Jenis Usaha</div>
                            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Daftar Jenis Usaha</h3>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center text-muted py-5">
                                    ...
                                    <div>Tidak ada data jenis usaha</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      name="description" rows="3" placeholder="Deskripsi singkat tentang jenis usaha ini">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
