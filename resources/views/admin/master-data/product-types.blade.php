        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">Tipe Produk</h2>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Total Tipe Produk</div>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="8" class="text-center text-muted py-5">
                                    ...
                                    <div>Tidak ada data tipe produk</div>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.master-data.product-types.store') }}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label required">Nama Tipe Produk</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      name="description" rows="3" placeholder="Deskripsi singkat tentang tipe produk ini">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
