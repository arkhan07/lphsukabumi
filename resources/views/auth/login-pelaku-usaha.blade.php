        ...
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <p class="text-center text-muted mb-4">Selamat datang! Silakan masukkan detail akun Anda</p>
                    ...
                    <div class="text-center">
                        <a href="{{ route('login.staff') }}" class="btn w-100">
                            Login untuk Staff Lembaga
                        </a>
                    </div>
                </div>
            </div>
