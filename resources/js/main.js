openTabs = function (evt, tabsName) {
...
openBlogs = function (evt, categoryName, Blog) {
    var i, categoryContent, tablinks;
    ...
    // Show the clicked category content and activate the clicked tab
